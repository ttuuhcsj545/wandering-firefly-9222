...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/wandering-firefly-9222
```

A live public deployment of this template is available at [https://wandering-firefly-9222.templates.workers.dev](https://wandering-firefly-9222.templates.workers.dev)
